...
Tools are nothing more than Python classes that inherit from [BaseTool](../../reference/griptape.tools.md#BaseTool).
Each method in the class is decorated with an [activity] decorator which informs the LLM how and when it should use that Tool Activity. 
