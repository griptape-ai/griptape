...
from griptape.config import OpenAiStructureConfig, StructureConfig
...
class Structure(ABC):
    ...
    config: StructureConfig = field(default=Factory(lambda: OpenAiStructureConfig()), kw_only=True)
