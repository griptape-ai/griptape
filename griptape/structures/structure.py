        ...
        return TaskMemory(
            artifact_storages={
                TextArtifact: TextArtifactStorage(
                    ...
                    vector_store_driver=Config.drivers.vector_store_driver,
                    summary_engine=PromptSummaryEngine(prompt_driver=Config.drivers.prompt_driver),
                    csv_extraction_engine=CsvExtractionEngine(prompt_driver=Config.drivers.prompt_driver),
                    json_extraction_engine=JsonExtractionEngine(prompt_driver=Config.drivers.prompt_driver),
                ),
