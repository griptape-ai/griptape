...
# Create a Document class (you can replace this with the real import)
class Document:
    def __init__(self, page_content: str, metadata: Dict):
        self.page_content = page_content
        self.metadata = metadata

# The existing ArxivAPIWrapper class
...
# The new Griptape BaseTool
class ArxivSearch(BaseTool):
    @activity(config={
        "description": "A tool for searching scientific articles on Arxiv.org",
        "schema": schema
    })
    def search(self, params: Dict) -> TextArtifact | ErrorArtifact:
        ...
        try:
            api_wrapper = ArxivAPIWrapper()  # Assuming ArxivAPIWrapper is properly initialized
            results = api_wrapper.run(query)  # Replace 'run' with your actual method
