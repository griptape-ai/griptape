...
class StructureTaskMemoryExtractionEngineConfig(SerializableMixin):
    csv: StructureTaskMemoryExtractionEngineCsvConfig = field(metadata={"serialize": True})
    json: StructureTaskMemoryExtractionEngineJsonConfig = field(metadata={"serialize": True})
