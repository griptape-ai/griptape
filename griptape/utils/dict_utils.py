...
def remove_field_unless_directly_inside(d: dict, field_name: str, exception_container_key: str) -> dict:
    """Recursively remove a field_name from schema dicts unless it appears as a property name inside the exception_container_key (e.g., 'properties').
    ...
    def _filter_recursively(obj: Any, *, inside_exception_container: bool) -> Any:
        ...
        for k, v in obj.items():
            if inside_exception_container:
                ...
                if k == exception_container_key and isinstance(v, dict):
                    filtered_dict[k] = _filter_recursively(
                        v, inside_exception_container=True
