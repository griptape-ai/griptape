...
class LeonardoImageGenerationDriver(BaseImageGenerationDriver):
    ...
    api_key: str = field(kw_only=True, metadata={"sensitive": True})
    requests_session: requests.Session = field(default=Factory(lambda: requests.Session()), kw_only=True)
    api_base: str = field(default="https://cloud.leonardo.ai/api/rest/v1", kw_only=True, metadata={"sensitive": True})
    max_attempts: int = field(default=10, kw_only=True, metadata={"sensitive": True})
    image_width: int = field(default=512, kw_only=True, metadata={"sensitive": True})
    image_height: int = field(default=512, kw_only=True, metadata={"sensitive": True})
    steps: Optional[int] = field(default=None, kw_only=True, metadata={"sensitive": True})
    seed: Optional[int] = field(default=None, kw_only=True, metadata={"sensitive": True})
    init_strength: Optional[float] = field(default=None, kw_only=True, metadata={"sensitive": True})
    control_net: bool = field(default=False, kw_only=True, metadata={"sensitive": True})
