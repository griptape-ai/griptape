...
class OpenAiPromptDriver(BasePromptDriver):  
    ...
    api_version: Optional[str] = field(default=os.getenv("API_VERSION", openai.api_version), kw_only=True)  
    ...
    model: str = field(default=os.getenv("ENGINE", TiktokenTokenizer.DEFAULT_MODEL), kw_only=True)  
