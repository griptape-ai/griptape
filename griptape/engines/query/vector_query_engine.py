...
class VectorQueryEngine(BaseQueryEngine):
    ...
    def query(
        self, query: str, metadata: Optional[str] = None, top_n: Optional[int] = None, namespace: Optional[str] = None
    ) -> TextArtifact:
        ...
        for artifact in artifacts:
            ...
            message = self.template_generator.render(metadata=metadata, query=query, text_segments=text_segments)
