...
class TestImageGenerationTask:
    ...
    def test_all_negative_rulesets_from_rulesets(self, engine):
        ...
        task = TextToImageTask(image_generation_engine=engine, negative_rulesets=[ruleset], output_dir="some/dir")
    ...
    def test_all_negative_rulesets_from_rules(self, engine):
        ...
        task = TextToImageTask(image_generation_engine=engine, negative_rules=[rule], output_dir="some/dir")
    ...
    def test_validate_output_dir(self, engine):
        with pytest.raises(ValueError):
            TextToImageTask(image_generation_engine=engine, output_dir="some/dir", output_file="some/file")
