...
class TestTranscriptionTool:
    ...
    def test_init_transcription_client(self, transcription_engine, audio_loader) -> None:
        assert AudioTranscriptionTool(engine=transcription_engine, audio_loader=audio_loader)
    ...
    def test_transcribe_audio_from_disk(self, transcription_engine, audio_loader) -> None:
        client = AudioTranscriptionTool(engine=transcription_engine, audio_loader=audio_loader)
