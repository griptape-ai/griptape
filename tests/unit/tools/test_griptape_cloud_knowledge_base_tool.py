...
class TestGriptapeCloudKnowledgeBaseTool:
    @pytest.fixture()
    def client(self, mocker):
        ...
        return GriptapeCloudKnowledgeBaseTool(
    ...
    def test_get_knowledge_base_description_error(self, client_no_description):
        exception_match_text = f"No description found for Knowledge Base {client_no_description.knowledge_base_id}. Please set a description, or manually set the `GriptapeCloudKnowledgeBaseTool.description` attribute."
