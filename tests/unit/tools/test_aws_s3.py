...
class TestAwsS3Client:
    ...
    def test_get_bucket_acl(self):
        ...
        assert (
            ...
            in AwsS3Client(session=boto3.Session(), off_prompt=False).get_bucket_acl({"values": value}).value
        )
    ...
    def test_get_bucket_policy(self):
        ...
        assert (
            ...
            in AwsS3Client(session=boto3.Session(), off_prompt=False).get_bucket_policy({"values": value}).value
        )
    ...
    def test_get_object_acl(self):
        ...
        assert (
            ...
            in AwsS3Client(session=boto3.Session(), off_prompt=False).get_object_acl({"values": value}).value
        )

    def test_list_s3_buckets(self):
        assert (
            "error listing s3 buckets"
            in AwsS3Client(session=boto3.Session(), off_prompt=False).list_s3_buckets({}).value
        )
    ...
    def test_list_objects(self):
        ...
        assert (
            ...
            in AwsS3Client(session=boto3.Session(), off_prompt=False).list_objects({"values": value}).value
        )
    ...
    def test_upload_memory_artifacts_to_s3(self):
        ...
        assert (
            "memory not found"
            in AwsS3Client(session=boto3.Session(), off_prompt=False)
    ...
    def test_upload_content_to_s3(self):
        ...
        assert (
            ...
            in AwsS3Client(session=boto3.Session(), off_prompt=False).upload_content_to_s3({"values": value}).value
        )
    ...
    def test_download_objects(self):
        ...
        assert (
            ...
            in AwsS3Client(session=boto3.Session(), off_prompt=False).download_objects({"values": value}).value
        )
