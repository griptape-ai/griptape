...
class TestGoogleDriveTool:
    def test_list_files(self):
        ...
        result = GoogleDriveTool(owner_email="tony@griptape.ai", service_account_credentials={}).list_files(
            {"values": value}
        )
    ...
    def test_save_content_to_drive(self):
        ...
        result = GoogleDriveTool(owner_email="tony@griptape.ai", service_account_credentials={}).save_content_to_drive(
            {"values": value}
        )
    ...
    def test_download_files(self):
        ...
        result = GoogleDriveTool(owner_email="tony@griptape.ai", service_account_credentials={}).download_files(
            {"values": value}
        )
    ...
    def test_search_files(self):
        ...
        result = GoogleDriveTool(owner_email="tony@griptape.ai", service_account_credentials={}).search_files(
            {"values": value}
        )
    ...
    def test_share_file(self):
        ...
        result = GoogleDriveTool(owner_email="tony@griptape.ai", service_account_credentials={}).share_file(
            {"values": value}
        )
