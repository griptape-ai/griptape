...
from griptape.tools import TaskMemoryTool
from tests.utils import defaults


class TestTaskMemoryTool:
    @pytest.fixture()
    def tool(self):
        return TaskMemoryTool(off_prompt=True, input_memory=[defaults.text_task_memory("TestMemory")])
