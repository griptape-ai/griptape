...
class TestLeonardoImageGenerationDriver:
    @pytest.fixture
    def driver(self) -> LeonardoImageGenerationDriver:
    ...
    def test_init(self, driver: LeonardoImageGenerationDriver) -> None:
        assert driver

    def test_create_generation(self, driver: LeonardoImageGenerationDriver) -> None:
    ...
    def _test_create_generation(self, driver: LeonardoImageGenerationDriver, test_generation_id: str) -> str:
    ...
    def test_get_image_url(self, driver: LeonardoImageGenerationDriver) -> None:
    ...
    def _test_get_image_url(self, driver: LeonardoImageGenerationDriver, test_image_url: str) -> str:
    ...
    def test_download_image(self, driver: LeonardoImageGenerationDriver) -> None:
    ...
    def _test_download_image(self, driver: LeonardoImageGenerationDriver, test_image_data: bytes) -> bytes:
    ...
    def test_generate_image(self, driver: LeonardoImageGenerationDriver) -> None:
        test_generation_id = str(uuid.uuid4())
        test_image_url = "test_image_url"
