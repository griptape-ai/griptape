...
class TestCoherePromptDriver:
    ...
    @pytest.mark.parametrize("native_structured_output_mode", ["native", "tool", "foo"])
    def test_try_run(
        self,
        mock_client,
        prompt_stack,
        ...
        mock_client.chat.assert_called_once_with(
            ...
            **{
                "tools": [
                    ...
                    *(
                        ...
                        if use_native_structured_output and native_structured_output_mode == "tool"
                        else []
                    ),
                ]
            }
            ...
            **{
            ...
            if use_native_structured_output and native_structured_output_mode == "native"
            else {},
            stop_sequences=[],
            temperature=0.1,
            foo="bar",
