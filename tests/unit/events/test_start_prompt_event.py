...
class TestStartPromptEvent:
    ...
    def test_to_dict(self, start_prompt_event):
        ...
        assert start_prompt_event.to_dict()["prompt_stack"]["inputs"][0]["content"][0]["artifact"]["value"] == "foo"
        assert start_prompt_event.to_dict()["prompt_stack"]["inputs"][0]["role"] == "user"
        assert start_prompt_event.to_dict()["prompt_stack"]["inputs"][1]["content"][0]["artifact"]["value"] == "bar"
