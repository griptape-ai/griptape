...
def get_fake_inspect_container(*, tty=False):
    ...
    response = {
        "Id": FAKE_CONTAINER_ID,
        "configs": {"Labels": {"foo": "bar"}, "Privileged": True, "Tty": tty},
        "ID": FAKE_CONTAINER_ID,
        "Image": "busybox:latest",
        "Name": "foobar",
        "State": {
        ...
        "HostConfig": {"LogConfig": {"Type": "json-file", "configs": {}}},
    ...
    return 200, [
        {
            ...
            "EnableIPv6": False,
            "Internal": False,
            "IPAM": {"Driver": "default", "configs": [{"Subnet": "172.17.0.0/16"}]},
            "Containers": {
                FAKE_CONTAINER_ID: {
...
fake_responses = {
    ...
    f"{prefix}/{CURRENT_VERSION}/containers/{FAKE_CONTAINER_ID}/start": post_fake_start_container,
    f"{prefix}/{CURRENT_VERSION}/containers/{FAKE_CONTAINER_ID}/resize": post_fake_resize_container,
    f"{prefix}/{CURRENT_VERSION}/containers/{FAKE_CONTAINER_ID}/json": get_fake_inspect_container,
    f"{prefix}/{CURRENT_VERSION}/containers/{FAKE_CONTAINER_ID}/rename": post_fake_rename_container,
    f"{prefix}/{CURRENT_VERSION}/images/{FAKE_IMAGE_ID}/tag": post_fake_tag_image,
    f"{prefix}/{CURRENT_VERSION}/containers/{FAKE_CONTAINER_ID}/wait": get_fake_wait,
    f"{prefix}/{CURRENT_VERSION}/containers/{FAKE_CONTAINER_ID}/logs": get_fake_logs,
    f"{prefix}/{CURRENT_VERSION}/containers/{FAKE_CONTAINER_ID}/changes": get_fake_diff,
    f"{prefix}/{CURRENT_VERSION}/containers/{FAKE_CONTAINER_ID}/export": get_fake_export,
    f"{prefix}/{CURRENT_VERSION}/containers/{FAKE_CONTAINER_ID}/update": post_fake_update_container,
    f"{prefix}/{CURRENT_VERSION}/containers/{FAKE_CONTAINER_ID}/exec": post_fake_exec_create,
    f"{prefix}/{CURRENT_VERSION}/exec/{FAKE_EXEC_ID}/start": post_fake_exec_start,
    f"{prefix}/{CURRENT_VERSION}/exec/{FAKE_EXEC_ID}/json": get_fake_exec_inspect,
    f"{prefix}/{CURRENT_VERSION}/exec/{FAKE_EXEC_ID}/resize": post_fake_exec_resize,
    f"{prefix}/{CURRENT_VERSION}/containers/{FAKE_CONTAINER_ID}/stats": get_fake_stats,
    f"{prefix}/{CURRENT_VERSION}/containers/{FAKE_CONTAINER_ID}/top": get_fake_top,
    f"{prefix}/{CURRENT_VERSION}/containers/{FAKE_CONTAINER_ID}/stop": post_fake_stop_container,
    f"{prefix}/{CURRENT_VERSION}/containers/{FAKE_CONTAINER_ID}/kill": post_fake_kill_container,
    f"{prefix}/{CURRENT_VERSION}/containers/{FAKE_CONTAINER_ID}/pause": post_fake_pause_container,
